...
**summary**
    - The aggregates are the building blocks of the DDD / Micro services
    - use the events to maintain the consistency b/w the aggregates
    - Event sourcing is the good way to implement the event driven architecture
------------------------------------------------------------------------------------------------
